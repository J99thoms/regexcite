...
**NOTE: This is a toy package created for educational purposes. It was created by following the [guide](https://r-pkgs.org/whole-game.html) found in the second edition of [R Packages](https://r-pkgs.org). It is not meant to actually be useful. If you want a package for factor handling, please see [stringr](https://stringr.tidyverse.org).**
